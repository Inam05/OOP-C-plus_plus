/*
Design a class BankAccount with methods to deposit, withdraw, and transfer funds. Implement
exception handling for insufficient funds, invalid account number, and other potential errors.
*/
